...
Il est important de rappeller qu'il faut demander un numéro de device via le service \textif{alloc_chrdev_region} au noyau pour que ça marche correctement. 
\textbf{Exécution du code : } \\
\begin{lstlisting}
# cat /proc/devices 
Character devices:
